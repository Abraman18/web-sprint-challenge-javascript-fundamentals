...
// Nested function can acces the variable internal because it is outside of it's scope, functions can look out but not in.
...
// console.log(animalNames(zooAnimals));
  ...
  */
  ...
  function lowerCaseNames(array){
    let newArray = array.map(function (elem, i) {
...
// console.log(lowPopulationAnimals(zooAnimals));
  ...
  */
  ...
  function USApop(array){
    let acc = 0;
    let sum = array.reduce(function (acc, item) {
